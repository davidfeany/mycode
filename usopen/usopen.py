...
def user_input_config(user_config_file):
    # Read user config file and configure switch accordingly
    print("def user_input_config(user_config_file):")
...
def main():
    ...
    ## Determine if new config should be applied and if so  apply new config
